...
class DynamicSceneGraphEvaluator {
    public:
        DynamicSceneGraphEvaluator(const ros::NodeHandle& nh, const ros::NodeHandle& nh_private);
    ...
    public:
         ...
         * @param response: The response with all error means, variances, and max values.
         * @return True always.
         */
        ...
        /**
         * @brief computeOptimizedError prunes graphs, runs the optimization and computes the 
        ...
        /**
         * @brief humanCallback wraps the humanCallback function for the dynamicSceneNode and tracks the
        ...
        /**
         * @brief getAllTransforms finds all transformations to the human frames at the given timestep
         */
        bool getAllTransforms(std::vector<tf::StampedTransform>& out_transforms, ros::Time& time){
         ...
         * @return -1 if the node's timestamp is not in the ground-truth directory. The distance between the node and
