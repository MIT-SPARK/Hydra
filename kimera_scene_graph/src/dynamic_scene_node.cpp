...
namespace kimera {
    ...
    void DynamicSceneGraph::humanCallback(const graph_cmr_ros::SMPLList::ConstPtr& msg){
    ...
    void DynamicSceneGraph::dynamicSceneNodeFromSMPL(graph_cmr_ros::SMPL& mesh, DynamicSceneNode& node) {
    ...
    inline void DynamicSceneGraph::setupEdgeMarker(visualization_msgs::Marker& edges, std::vector<float>& color){
    ...
    void DynamicSceneGraph::drawEdgesBetweenSkeletons(const DynamicSceneNode& start, const DynamicSceneNode& end, visualization_msgs::Marker& out_edges){
    ...
    void DynamicSceneGraph::drawSkeletonEdges(DynamicSceneNode& node, visualization_msgs::Marker& marker){
        for (size_t idx = 0 ; idx < NUM_JOINTS; idx++){
